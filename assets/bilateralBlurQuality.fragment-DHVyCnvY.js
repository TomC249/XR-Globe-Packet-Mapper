import{t as e}from"./shaderStore-Dw977DTa.js";var t=`bilateralBlurQualityPixelShader`,n=`uniform sampler2D textureSampler;uniform sampler2D depthSampler;uniform sampler2D normalSampler;uniform int filterSize;uniform vec2 blurDir;uniform float depthThreshold;uniform float normalThreshold;varying vec2 vUV;void main(void) {vec3 color=textureLod(textureSampler,vUV,0.).rgb;float depth=textureLod(depthSampler,vUV,0.).x;if (depth>=1e6 || depth<=0.) {glFragColor=vec4(color,1.);return;}
...
//# sourceMappingURL=bilateralBlurQuality.fragment-DHVyCnvY.js.map