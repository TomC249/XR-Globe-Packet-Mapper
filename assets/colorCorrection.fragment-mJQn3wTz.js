import{t as e}from"./shaderStore-DZjcEDJh.js";var t=`colorCorrectionPixelShader`,n=`uniform sampler2D textureSampler; 
...
void main(void)
{vec4 screen_color=texture2D(textureSampler,vUV);gl_FragColor=sampleAs3DTexture(colorTable,screen_color.rgb,SLICE_COUNT);}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as t};
//# sourceMappingURL=colorCorrection.fragment-mJQn3wTz.js.map