import{t as e}from"./shaderStore-Dw977DTa.js";var t=`convolutionPixelShader`,n=`varying vUV: vec2f;var textureSamplerSampler: sampler;var textureSampler: texture_2d<f32>;uniform screenSize: vec2f;uniform kernel: array<f32,9>;
...
fragmentOutputs.color= vec4f((colorSum/kernelWeight).rgb,1);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as t};
//# sourceMappingURL=convolution.fragment-qo-H1cdC.js.map