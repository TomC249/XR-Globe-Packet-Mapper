import{t as e}from"./shaderStore-DZjcEDJh.js";var t=`fluidRenderingStandardBlurPixelShader`,n=`uniform sampler2D textureSampler;uniform int filterSize;uniform vec2 blurDir;varying vec2 vUV;void main(void) {vec4 s=textureLod(textureSampler,vUV,0.);if (s.r==0.) {glFragColor=vec4(0.,0.,0.,1.);return;}
...
//# sourceMappingURL=fluidRenderingStandardBlur.fragment-CaRP83uN.js.map