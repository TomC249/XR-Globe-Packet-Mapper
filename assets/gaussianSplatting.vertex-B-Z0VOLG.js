import{t as e}from"./shaderStore-DZjcEDJh.js";import"./clipPlaneVertexDeclaration-DGXX8QeY.js";import"./clipPlaneVertex-bgd5rCvN.js";import"./helperFunctions-BAm9aq7c.js";import"./sceneUboDeclaration-DdO6sdif.js";import"./meshUboDeclaration-BC3NeGf-.js";import"./fogVertexDeclaration-hH6zJkJ6.js";import"./logDepthDeclaration-BcOMjcfh.js";import"./fogVertex-XAydmYnt.js";import"./logDepthVertex-CzANwIJn.js";var t=`gaussianSplattingVertexDeclaration`,n=`attribute vec2 position;uniform mat4 view;uniform mat4 projection;uniform mat4 world;uniform vec4 vEyePosition;`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=n);var r=`gaussianSplattingUboDeclaration`,i=`#include<sceneUboDeclaration>
#include<meshUboDeclaration>
attribute vec2 position;`;e.IncludesShadersStore[r]||(e.IncludesShadersStore[r]=i);var a=`gaussianSplatting`,o=`#if !defined(WEBGL2) && !defined(WEBGPU) && !defined(NATIVE)
...
vCenter 
+ ((meshPos.x*majorAxis
+ meshPos.y*minorAxis)*invViewport*pos2d.w)*scale,pos2d.zw);}`;e.IncludesShadersStore[a]||(e.IncludesShadersStore[a]=o);var s=`gaussianSplattingVertexShader`,c=`#include<__decl__gaussianSplattingVertex>
...
`;e.ShadersStore[s]||(e.ShadersStore[s]=c);var l={name:s,shader:c};export{l as t};
//# sourceMappingURL=gaussianSplatting.vertex-B-Z0VOLG.js.map