import{t as e}from"./shaderStore-DZjcEDJh.js";var t=`glowBlurPostProcessPixelShader`,n=`varying vec2 vUV;uniform sampler2D textureSampler;uniform vec2 screenSize;uniform vec2 direction;uniform float blurWidth;float getLuminance(vec3 color)
...
gl_FragColor=baseColor;}`;e.ShadersStore[t]||(e.ShadersStore[t]=n);var r={name:t,shader:n};export{r as t};
//# sourceMappingURL=glowBlurPostProcess.fragment-X-blruAt.js.map