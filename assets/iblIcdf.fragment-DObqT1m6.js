import{t as e}from"./shaderStore-DZjcEDJh.js";import"./helperFunctions-DbfHdnYV.js";var t=`iblIcdfPixelShader`,n=`#include<helperFunctions>
varying vUV: vec2f;
...
.r;var pixelLuminance: f32=fetchLuminance(input.vUV);outputColor.z=pixelLuminance/(2.0*PI*normalization);fragmentOutputs.color=vec4( outputColor,1.0);}`;e.ShadersStoreWGSL[t]||(e.ShadersStoreWGSL[t]=n);var r={name:t,shader:n};export{r as t};
//# sourceMappingURL=iblIcdf.fragment-DObqT1m6.js.map