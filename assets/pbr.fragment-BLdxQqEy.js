import{t as e}from"./shaderStore-DZjcEDJh.js";import"./helperFunctions-DbfHdnYV.js";import"./oitFragment-DEZxMtqS.js";import"./clipPlaneFragmentDeclaration-BJnxRo6J.js";import"./clipPlaneFragment-IU9XYTG2.js";import"./logDepthDeclaration-DewWwhww.js";import"./reflectionFunction-AgQbFySr.js";import"./imageProcessingDeclaration-VXpnbfrK.js";import"./lightUboDeclaration-BT7hNfr7.js";import"./ltcHelperFunctions-BW6p6J_S.js";import"./shadowsFragmentFunctions-DzWvoTGl.js";import"./imageProcessingFunctions-B_IBPuJD.js";import"./fogFragmentDeclaration-C19_y4g-.js";import"./lightFragment-Cmepry6Q.js";import"./logDepthFragment-DevqAfKc.js";import"./fogFragment-FHisueO1.js";import"./harmonicsFunctions-BT6IsJS4.js";import"./mainUVVaryingDeclaration-DQYmD_-p.js";import"./bumpFragmentFunctions-DHvq4iat.js";import"./hdrFilteringFunctions-BkUgcjRZ.js";import"./pbrBRDFFunctions-hQTEXrFR.js";import"./bumpFragmentMainFunctions-DE5LOcSG.js";import"./bumpFragment-Bc7IOsGn.js";var t=`pbrFragmentExtraDeclaration`,ee=`varying vPositionW: vec3f;
#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[i]||(e.IncludesShadersStoreWGSL[i]=a);var o=`subSurfaceScatteringFunctions`,te=`fn testLightingForSSS(diffusionProfile: f32)->bool
{return diffusionProfile<1.;}`;e.IncludesShadersStoreWGSL[o]||(e.IncludesShadersStoreWGSL[o]=te);var s=`pbrHelperFunctions`,c=`#define MINIMUMVARIANCE 0.0005
...
#endif
}`;e.IncludesShadersStoreWGSL[d]||(e.IncludesShadersStoreWGSL[d]=f);var p=`pbrDirectLightingFunctions`,ne=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{diffuse: vec3f,
#ifdef SPECULARTERM
specular: vec3f,
...
#endif
`;e.IncludesShadersStoreWGSL[p]||(e.IncludesShadersStoreWGSL[p]=ne);var m=`pbrIBLFunctions`,re=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStoreWGSL[m]||(e.IncludesShadersStoreWGSL[m]=re);var h=`pbrBlockAlbedoOpacity`,g=`struct albedoOpacityOutParams
{surfaceAlbedo: vec3f,
alpha: f32};
#define pbr_inline
...
`;e.IncludesShadersStoreWGSL[h]||(e.IncludesShadersStoreWGSL[h]=g);var _=`pbrBlockReflectivity`,v=`struct reflectivityOutParams
{microSurface: f32,
roughness: f32,
...
`;e.IncludesShadersStoreWGSL[_]||(e.IncludesShadersStoreWGSL[_]=v);var y=`pbrBlockAmbientOcclusion`,b=`struct ambientOcclusionOutParams
{ambientOcclusionColor: vec3f,
...
`;e.IncludesShadersStoreWGSL[y]||(e.IncludesShadersStoreWGSL[y]=b);var x=`pbrBlockAlphaFresnel`,S=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[x]||(e.IncludesShadersStoreWGSL[x]=S);var C=`pbrBlockAnisotropic`,ie=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStoreWGSL[C]||(e.IncludesShadersStoreWGSL[C]=ie);var w=`pbrBlockReflection`,ae=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStoreWGSL[w]||(e.IncludesShadersStoreWGSL[w]=ae);var T=`pbrBlockSheen`,oe=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStoreWGSL[T]||(e.IncludesShadersStoreWGSL[T]=oe);var E=`pbrBlockClearcoat`,se=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[E]||(e.IncludesShadersStoreWGSL[E]=se);var D=`pbrBlockIridescence`,O=`struct iridescenceOutParams
{iridescenceIntensity: f32,
iridescenceIOR: f32,
...
#endif
`;e.IncludesShadersStoreWGSL[D]||(e.IncludesShadersStoreWGSL[D]=O);var k=`pbrBlockSubSurface`,A=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStoreWGSL[k]||(e.IncludesShadersStoreWGSL[k]=A);var j=`pbrBlockNormalGeometric`,M=`var viewDirectionW: vec3f=normalize(scene.vEyePosition.xyz-input.vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStoreWGSL[j]||(e.IncludesShadersStoreWGSL[j]=M);var N=`pbrBlockNormalFinal`,P=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStoreWGSL[N]||(e.IncludesShadersStoreWGSL[N]=P);var F=`pbrBlockLightmapInit`,I=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStoreWGSL[F]||(e.IncludesShadersStoreWGSL[F]=I);var L=`pbrBlockGeometryInfo`,R=`var NdotVUnclamped: f32=dot(normalW,viewDirectionW);var NdotV: f32=absEps(NdotVUnclamped);var alphaG: f32=convertRoughnessToAverageSlope(roughness);var AARoughnessFactors: vec2f=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
`;e.IncludesShadersStoreWGSL[z]||(e.IncludesShadersStoreWGSL[z]=B);var V=`pbrBlockReflectance`,H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[V]||(e.IncludesShadersStoreWGSL[V]=H);var U=`pbrBlockDirectLighting`,W=`var diffuseBase: vec3f=vec3f(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStoreWGSL[U]||(e.IncludesShadersStoreWGSL[U]=W);var G=`pbrBlockFinalLitComponents`,ce=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStoreWGSL[G]||(e.IncludesShadersStoreWGSL[G]=ce);var K=`pbrBlockFinalUnlitComponents`,le=`var finalDiffuse: vec3f=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStoreWGSL[K]||(e.IncludesShadersStoreWGSL[K]=le);var q=`pbrBlockFinalColorComposition`,ue=`var finalColor: vec4f= vec4f(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStoreWGSL[q]||(e.IncludesShadersStoreWGSL[q]=ue);var J=`pbrBlockImageProcessing`,Y=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStoreWGSL[J]||(e.IncludesShadersStoreWGSL[J]=Y);var X=`pbrBlockPrePass`,de=`var writeGeometryInfo: f32=select(0.0,1.0,finalColor.a>ALPHATESTVALUE);var fragData: array<vec4<f32>,SCENE_MRT_COUNT>;
...
#endif
`;e.IncludesShadersStoreWGSL[X]||(e.IncludesShadersStoreWGSL[X]=de);var Z=`pbrDebug`,fe=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStoreWGSL[Z]||(e.IncludesShadersStoreWGSL[Z]=fe);var Q=`pbrPixelShader`,$=`#define CUSTOM_FRAGMENT_BEGIN
...
`;e.ShadersStoreWGSL[Q]||(e.ShadersStoreWGSL[Q]=$);var pe={name:Q,shader:$};export{pe as t};
//# sourceMappingURL=pbr.fragment-BLdxQqEy.js.map