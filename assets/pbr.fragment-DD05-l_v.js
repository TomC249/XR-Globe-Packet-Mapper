import{t as e}from"./shaderStore-Dw977DTa.js";import"./clipPlaneFragmentDeclaration-B1azhEJc.js";import"./clipPlaneFragment-CGyUD0Zd.js";import"./helperFunctions-Cs35sAMQ.js";import"./logDepthDeclaration-Bchv1FGt.js";import"./reflectionFunction-BBAOD3HU.js";import"./imageProcessingDeclaration-C0CDfsuh.js";import"./lightFragmentDeclaration-D2AZ0s64.js";import"./lightUboDeclaration-D-lhwveb.js";import"./ltcHelperFunctions-Bnwy27bX.js";import"./shadowsFragmentFunctions-D2xtLcyP.js";import"./imageProcessingFunctions-R67Rk2OJ.js";import"./fogFragmentDeclaration-QYXFhRxV.js";import"./lightFragment-CrlT6u2j.js";import"./logDepthFragment-CAb67byh.js";import"./fogFragment-DHsBd1GN.js";import"./harmonicsFunctions-Yj500tjV.js";import"./mainUVVaryingDeclaration-CeTsejFO.js";import"./oitFragment-zkGUiuyQ.js";import"./bumpFragmentFunctions-COzhgV_Y.js";import"./hdrFilteringFunctions-DWMaJEAj.js";import"./pbrBRDFFunctions-Dyh_-r6u.js";import"./bumpFragmentMainFunctions-DjNnqsdG.js";import"./bumpFragment-DvV54rTZ.js";var t=`pbrFragmentDeclaration`,ee=`uniform vec4 vEyePosition;uniform vec3 vReflectionColor;uniform vec4 vAlbedoColor;uniform float baseWeight;uniform vec4 vLightingIntensity;uniform vec4 vReflectivityColor;uniform vec4 vMetallicReflectanceFactors;uniform vec3 vEmissiveColor;uniform float visibility;uniform vec3 vAmbientColor;
#ifdef ALBEDO
...
`;e.IncludesShadersStore[t]||(e.IncludesShadersStore[t]=ee);var n=`pbrFragmentExtraDeclaration`,r=`varying vec3 vPositionW;
#if DEBUGMODE>0
...
varying vec4 vColor;
#endif
`;e.IncludesShadersStore[n]||(e.IncludesShadersStore[n]=r);var i=`samplerFragmentAlternateDeclaration`,a=`#ifdef _DEFINENAME_
...
#endif
#endif
`;e.IncludesShadersStore[i]||(e.IncludesShadersStore[i]=a);var o=`pbrFragmentSamplersDeclaration`,te=`#include<samplerFragmentDeclaration>(_DEFINENAME_,ALBEDO,_VARYINGNAME_,Albedo,_SAMPLERNAME_,albedo)
...
#endif
`;e.IncludesShadersStore[o]||(e.IncludesShadersStore[o]=te);var s=`subSurfaceScatteringFunctions`,c=`bool testLightingForSSS(float diffusionProfile)
{return diffusionProfile<1.;}`;e.IncludesShadersStore[s]||(e.IncludesShadersStore[s]=c);var l=`pbrHelperFunctions`,u=`#define MINIMUMVARIANCE 0.0005
...
#endif
`;e.IncludesShadersStore[l]||(e.IncludesShadersStore[l]=u);var d=`pbrDirectLightingSetupFunctions`,ne=`struct preLightingInfo
...
#endif
`;e.IncludesShadersStore[d]||(e.IncludesShadersStore[d]=ne);var f=`pbrDirectLightingFalloffFunctions`,re=`float computeDistanceLightFalloff_Standard(vec3 lightOffset,float range)
...
#endif
}`;e.IncludesShadersStore[f]||(e.IncludesShadersStore[f]=re);var p=`pbrDirectLightingFunctions`,ie=`#define CLEARCOATREFLECTANCE90 1.0
struct lightingInfo
{vec3 diffuse;
#ifdef SPECULARTERM
vec3 specular;
...
#endif
`;e.IncludesShadersStore[p]||(e.IncludesShadersStore[p]=ie);var m=`pbrIBLFunctions`,h=`#if defined(REFLECTION) || defined(SS_REFRACTION)
...
#endif
`;e.IncludesShadersStore[m]||(e.IncludesShadersStore[m]=h);var g=`pbrBlockAlbedoOpacity`,_=`struct albedoOpacityOutParams
...
`;e.IncludesShadersStore[g]||(e.IncludesShadersStore[g]=_);var v=`pbrBlockReflectivity`,y=`struct reflectivityOutParams
...
`;e.IncludesShadersStore[v]||(e.IncludesShadersStore[v]=y);var b=`pbrBlockAmbientOcclusion`,x=`struct ambientOcclusionOutParams
{vec3 ambientOcclusionColor;
...
`;e.IncludesShadersStore[b]||(e.IncludesShadersStore[b]=x);var S=`pbrBlockAlphaFresnel`,ae=`#ifdef ALPHAFRESNEL
...
#endif
#endif
`;e.IncludesShadersStore[S]||(e.IncludesShadersStore[S]=ae);var C=`pbrBlockAnisotropic`,oe=`#ifdef ANISOTROPIC
...
#endif
`;e.IncludesShadersStore[C]||(e.IncludesShadersStore[C]=oe);var w=`pbrBlockReflection`,se=`#ifdef REFLECTION
...
#endif
`;e.IncludesShadersStore[w]||(e.IncludesShadersStore[w]=se);var T=`pbrBlockSheen`,ce=`#ifdef SHEEN
...
#endif
`;e.IncludesShadersStore[T]||(e.IncludesShadersStore[T]=ce);var E=`pbrBlockClearcoat`,le=`struct clearcoatOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[E]||(e.IncludesShadersStore[E]=le);var D=`pbrBlockIridescence`,O=`struct iridescenceOutParams
...
#endif
`;e.IncludesShadersStore[D]||(e.IncludesShadersStore[D]=O);var k=`pbrBlockSubSurface`,A=`struct subSurfaceOutParams
...
return outParams;}
#endif
`;e.IncludesShadersStore[k]||(e.IncludesShadersStore[k]=A);var j=`pbrBlockNormalGeometric`,M=`vec3 viewDirectionW=normalize(vEyePosition.xyz-vPositionW);
#ifdef NORMAL
...
#endif
`;e.IncludesShadersStore[j]||(e.IncludesShadersStore[j]=M);var N=`pbrBlockNormalFinal`,P=`#if defined(FORCENORMALFORWARD) && defined(NORMAL)
...
#endif
`;e.IncludesShadersStore[N]||(e.IncludesShadersStore[N]=P);var F=`pbrBlockLightmapInit`,I=`#ifdef LIGHTMAP
...
#endif
`;e.IncludesShadersStore[F]||(e.IncludesShadersStore[F]=I);var L=`pbrBlockGeometryInfo`,R=`float NdotVUnclamped=dot(normalW,viewDirectionW);float NdotV=absEps(NdotVUnclamped);float alphaG=convertRoughnessToAverageSlope(roughness);vec2 AARoughnessFactors=getAARoughnessFactors(normalW.xyz);
#ifdef SPECULARAA
...
#endif
#endif
`;e.IncludesShadersStore[L]||(e.IncludesShadersStore[L]=R);var z=`pbrBlockReflectance0`,B=`float reflectance=max(max(reflectivityOut.surfaceReflectivityColor.r,reflectivityOut.surfaceReflectivityColor.g),reflectivityOut.surfaceReflectivityColor.b);vec3 specularEnvironmentR0=reflectivityOut.surfaceReflectivityColor.rgb;
#ifdef METALLICWORKFLOW
...
#endif
`;e.IncludesShadersStore[z]||(e.IncludesShadersStore[z]=B);var V=`pbrBlockReflectance`,H=`#if defined(ENVIRONMENTBRDF) && !defined(REFLECTIONMAP_SKYBOX)
...
#endif
#endif
`;e.IncludesShadersStore[V]||(e.IncludesShadersStore[V]=H);var U=`pbrBlockDirectLighting`,W=`vec3 diffuseBase=vec3(0.,0.,0.);
#ifdef SPECULARTERM
...
#endif
`;e.IncludesShadersStore[U]||(e.IncludesShadersStore[U]=W);var G=`pbrBlockFinalLitComponents`,ue=`aggShadow=aggShadow/numLights;
#if defined(ENVIRONMENTBRDF)
...
#endif
#endif
`;e.IncludesShadersStore[G]||(e.IncludesShadersStore[G]=ue);var K=`pbrBlockFinalUnlitComponents`,de=`vec3 finalDiffuse=diffuseBase;
#if !defined(SS_TRANSLUCENCY)
...
`;e.IncludesShadersStore[K]||(e.IncludesShadersStore[K]=de);var q=`pbrBlockFinalColorComposition`,J=`vec4 finalColor=vec4(
#ifndef UNLIT
#ifdef REFLECTION
finalIrradiance +
#endif
...
`;e.IncludesShadersStore[q]||(e.IncludesShadersStore[q]=J);var Y=`pbrBlockImageProcessing`,fe=`#if defined(IMAGEPROCESSINGPOSTPROCESS) || defined(SS_SCATTERING)
...
#endif
`;e.IncludesShadersStore[Y]||(e.IncludesShadersStore[Y]=fe);var X=`pbrBlockPrePass`,pe=`float writeGeometryInfo=finalColor.a>ALPHATESTVALUE ? 1.0 : 0.0;
...
#endif
#endif
`;e.IncludesShadersStore[X]||(e.IncludesShadersStore[X]=pe);var Z=`pbrDebug`,me=`#if DEBUGMODE>0
...
#endif
`;e.IncludesShadersStore[Z]||(e.IncludesShadersStore[Z]=me);var Q=`pbrPixelShader`,$=`#define CUSTOM_FRAGMENT_EXTENSION
...
`;e.ShadersStore[Q]||(e.ShadersStore[Q]=$);var he={name:Q,shader:$};export{he as t};
//# sourceMappingURL=pbr.fragment-DD05-l_v.js.map