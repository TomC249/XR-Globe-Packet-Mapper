import{t as e}from"./shaderStore-Dw977DTa.js";import"./logDepthDeclaration-BI2GPZxE.js";import"./fogFragmentDeclaration-bevVmJH2.js";import"./logDepthFragment-CY-EhT5J.js";import"./fogFragment-DKDJXo0_.js";var t=`imageProcessingCompatibility`,n=`#ifdef IMAGEPROCESSINGPOSTPROCESS
fragmentOutputs.color=vec4f(pow(fragmentOutputs.color.rgb, vec3f(2.2)),fragmentOutputs.color.a);
#endif
`;e.IncludesShadersStoreWGSL[t]||(e.IncludesShadersStoreWGSL[t]=n);var r=`spritesPixelShader`,i=`uniform alphaTest: i32;varying vColor: vec4f;varying vUV: vec2f;var diffuseSamplerSampler: sampler;var diffuseSampler: texture_2d<f32>;
...
//# sourceMappingURL=sprites.fragment-Cj-hwLVt.js.map