    ...
    const effect = engine.createEffect(shaderName, {
      ...
      extraInitializationsAsync: this._shadersLoaded ? void 0 : async () => {
        if (this.shaderLanguage === 1) {
          await Promise.all([import("./pbr.vertex-TB6R3F65.js"), import("./pbr.fragment-SRJ2KJCU.js")]);
        } else {
          await Promise.all([import("./pbr.vertex-ICNTBI6T.js"), import("./pbr.fragment-5SNHMQN6.js")]);
        }
...
//# sourceMappingURL=chunk-IDVBCOB5.js.map
