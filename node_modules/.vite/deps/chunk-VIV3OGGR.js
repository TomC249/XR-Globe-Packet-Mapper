...
function _GetCompatibleTextureLoader(extension, mimeType) {
  ...
  if (!_registeredTextureLoaders.has(extension)) {
    ...
    if (extension.endsWith(".dds")) {
      registerTextureLoader(".dds", () => import("./ddsTextureLoader-5V3IOV5K.js").then((module) => new module._DDSTextureLoader()));
    }
    if (extension.endsWith(".basis")) {
      registerTextureLoader(".basis", () => import("./basisTextureLoader-VEQDFDXE.js").then((module) => new module._BasisTextureLoader()));
    }
    if (extension.endsWith(".env")) {
      registerTextureLoader(".env", () => import("./envTextureLoader-GOGJD7DT.js").then((module) => new module._ENVTextureLoader()));
    }
    ...
    if (extension.endsWith(".ktx") || extension.endsWith(".ktx2")) {
      registerTextureLoader(".ktx", () => import("./ktxTextureLoader-QTVONNBM.js").then((module) => new module._KTXTextureLoader()));
      registerTextureLoader(".ktx2", () => import("./ktxTextureLoader-QTVONNBM.js").then((module) => new module._KTXTextureLoader()));
    }
    ...
    if (extension.endsWith(".exr")) {
      registerTextureLoader(".exr", () => import("./exrTextureLoader-AWXBY6TR.js").then((module) => new module._ExrTextureLoader()));
    }
  }
...
//# sourceMappingURL=chunk-VIV3OGGR.js.map
